...
test: $(sDir)test.cpp $(bDir)standard_sudoku.o $(bDir)donut_sudoku.o $(bDir)overlapping_sudoku.o $(bDir)star_sudoku.o $(bDir)color_sudoku.o
	g++ $(sDir)test.cpp -o test $(bDir)standard_sudoku.o $(args) $(bDir)donut_sudoku.o $(bDir)overlapping_sudoku.o $(bDir)star_sudoku.o $(bDir)color_sudoku.o
